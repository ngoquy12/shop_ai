...
export const metadata: Metadata = {
  ...
  keywords: [
    "khóa học AI", "học AI online", "khóa học ChatGPT", "khóa học Midjourney",
    "khóa học VEO3", "AI Marketing", "lập trình AI", "học AI tiếng Việt",
    "prompt engineering", "khóa học AI Việt Nam",
  ],
  openGraph: {
    title: "Khóa Học AI Thực Chiến | VideoPrompt",
    description: "Làm chủ các công cụ AI hàng đầu với khóa học thực chiến từ chuyên gia. Học linh hoạt, áp dụng ngay.",
    type: "website",
    locale: "vi_VN",
  },
}
